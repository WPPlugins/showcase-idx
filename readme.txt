...
**[Get Started with a Free 14-day Trial](https://showcaseidx.com/pricing/)**

[Showcase IDX](https://showcaseidx.com/) lets real estate agents embed a beautifully simple, yet surprisingly powerful, home search into their site. Focusing on your visitor's experience, Showcase IDX gives your users a great experience and a reason to come back to your website to continue their home search. Built using the latest technologies that allows us to regularly upgrade and tweak the product, so your investment continues to grow and evolve over time.

= Simple and Beautiful =
Designed to make your site look amazing to your current and future clients. With years of experience in the real estate industry we've selected the features that users use most and simplified them. To see show Showcase IDX looks check out our [Live Demo](https://showcaseidx.com/live-demo/ "Showcase IDX Live Demo").
...
*   A lot more... [Check out our site](https://showcaseidx.com/features/ "Showcase IDX Features") for more info on our features.

== Installation ==

1. Sign up for an account at [showcaseidx.com](https://showcaseidx.com/pricing/ "Showcase IDX Plans and Pricing")
...
**Step 3 - Installation**
We've made it as easy as possible to install the plugin on your site, so just follow the written-for-Realtors instructions and you should be good! If you have any issues, put in a [support ticket](https://showcaseidx.com/support/).
...
**Create a full-width page for the IDX to be embedded on and call it Home Search.**
The search plugin takes up the full page. We have found that making it full width reduces user distraction which means they are less likely to click away and more likely to register or ask a question through the IDX.
