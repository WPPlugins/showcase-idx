    ...
    <div class="card">
      ...
      if ( !get_option( 'showcaseidx_website_uuid' ) ) {
        ...
        <p class="submit center">
          <a class="button button-primary" href="<?php echo SHOWCASEIDX_AGENT_HOST . '/provision/' . get_option( 'showcaseidx_install_id' ) . '?return_to=' . menu_page_url( 'showcaseidx', false ); ?>">Activate Your Wordpress Plugin</a>
        </p>

        <h3 class="center">Don't have a Showcase IDX account?</h3>
        <h2 class="center"><a href="https://showcaseidx.com/pricing/" target="_blank">Sign up for Showcase IDX</a></h2>
        <?php
      } else {
        ?>
